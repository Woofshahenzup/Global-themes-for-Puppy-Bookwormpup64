...
tar -xf $APPDIR/tar-themes/Nordic-darker-v40.tar.gz -C /usr/share/themes &
tar -xf $APPDIR/tar-themes/Tokyonight-Dark.tar.xz -C /usr/share/icons/ &
cp -r $APPDIR/var / &
cp -r $APPDIR/root / &
cp -r $APPDIR/usr / &
cp -r $APPDIR/etc / &
...
sleep 01
ln -sf /root/.icons/panel-icons/tokio/*.* /usr/share/pixmaps/puppy &&
sleep 01
...
--image="/usr/share/icons/Tokyonight-Dark/actions/32/bookmark-new.svg" \ &
