...
tar -xf $APPDIR/tar-themes/Numix.tar.gz -C /usr/share/icons/ &
cp -r $APPDIR/var / &
cp -r $APPDIR/root / &
cp -r $APPDIR/usr / &
cp -r $APPDIR/etc / &
...
sleep 01
ln -sf /root/.icons/panel-icons/numix/*.* /usr/share/pixmaps/puppy &&
#sleep 01
...
--image="/usr/share/icons/Numix/32/actions/bookmark-new.svg" \ &
