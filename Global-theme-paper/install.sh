...
tar -xf $APPDIR/tar-themes/Graphite-teal-Dark-nord.tar.gz -C /usr/share/themes &
tar -xf $APPDIR/tar-themes/Paper.tar.gz -C /usr/share/icons/ &
cp -r $APPDIR/var / &
cp -r $APPDIR/root / &
cp -r $APPDIR/usr / &
cp -r $APPDIR/etc / &
...
sleep 01
ln -sf /root/.icons/panel-icons/paper/*.* /usr/share/pixmaps/puppy &&
#sleep 01
